...
ui <- dashboardPage( skin = "green",
                     ...
                     dashboardSidebar(
                       ...
                       sidebarMenu(
                         ...
                         menuItem("Válogató1", tabName = "dataselect1", icon = icon("filter")), #menuitem(dataselect2)
                         
                         menuItem("Charts", icon = icon("bar-chart-o"),
                                  menuSubItem("Külföldi dolgozó", tabName = "subitem1"),
                                  menuSubItem("Nem és státusz", tabName = "subitem2")), #menuItem(charts) 
                       ...
                       tabItems(
                         tabItem("dashboard",
                                 div(h1("Áttekintő"),
                                     ...
                                     box(plotOutput("plot1"), width = 7), #plot1
                                     box(plotOutput("plot2"), width = 3), #plot2
                                     box(plotOutput("plot3"), width = 7), #plot3
...
#rendering dataset ----  
  ...
  output$sg_credit <- renderDataTable({sgc_data},
